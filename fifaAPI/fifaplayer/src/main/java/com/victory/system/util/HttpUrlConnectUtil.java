...
public class HttpUrlConnectUtil {
	...
	public <T, K> K apiGet(String url, T obj, Map<String, Object> header, Class<K> cls){

		HttpHeaders reqheader = setHeader(header);
		HttpEntity<T> entity = new HttpEntity<>(reqheader);

		log.info("params : {}", obj);


		//ResponseEntity<K> respEntity = restTemplate.getForEntity(fifaServer + url, cls, entity);
		ResponseEntity<K> respEntity = restTemplate.exchange(
				fifaServer + url,
				  HttpMethod.GET,
				  entity,
				  cls
	...
	public <T, K> K apiGet(String url, T obj, Class<K> cls){
	 ...
	 */
	@SuppressWarnings("unchecked")
	public <T, K> K apiGet(String url, T obj, Map<String, Object> header){
		Map<String, Object> paramobj = (Map<String, Object>) obj;
	 ...
	 * @return : param으로 받은 객체 그대로
	 */
	public <T, K> K apiPost(String url, T obj, Map<String, Object> header, Class<K> cls){
	 ...
	 * @return : param으로 받은 객체 그대로
	 */
	public <T, K> K apiPost(String url, T obj, Class<K> cls) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public <T, K> K apiPost(String url, T obj){
		Map<String, Object> paramobj = (Map<String, Object>) obj;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public <T, K> K apiPost(String url, T obj, Map<String, Object> header)  {
		Map<String, Object> paramobj = (Map<String, Object>) obj;
